...
def main():
    ...
    # Title
    d.text((80, 168), "The Godfather", font=f_title, fill=CREAM)
    ...
    # Subtitle
    sub_lines = [
        "The novel, the trilogy, the sequels,",
        "the people, and the analysis.",
    ]
    y = 348
    ...
    # Footer
    footer = "joedef.github.io/godfather-wiki"
    d.text((80, H - 92), footer, font=f_foot, fill=GOLD)

    # Right-hand section chips
    chips = ["FILMS", "BOOKS", "CHARACTERS", "PEOPLE", "ANALYSIS", "DATA"]
